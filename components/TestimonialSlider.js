...
//w-[330px] h-[200px] sm:w-[470px] sm:h-[300px] 2xl:w-[600px] 2xl:h-400px
   return (
    <div className='flex font-Sa text-[#A1A1A1] font-medium text-[14x] md:text-[18px] space-x-8 sm:space-x-16 2xl:space-x-20 overflow-x-scroll scrollbar-hide relative' >
    {slidersData.map(
             (data)=>
         <div className='first:pl-5 last:pr-5 cursor-pointer transition ease-in-out duration-300 transform hover:scale-110 rounded-md shadow-md bg-white px-4 sm:px-8 2xl:px-12 py-6 2xl:py-12  ' key={data.data[0]}>
            <p className='text-[10px] sm:text-[14px] 2xl:text-[20px] w-[280px]  sm:w-[470px]  2xl:w-[600px]  mb-2 sm:mb-4'>high-defination video is video of higher resolution and quality than standard definition. high-defination video is video of higher resolution and quality than standard definition. hbuild your future with our quality education. the best and largest all-in-one online tutoring platform in the worldd definition. high-defination video is video of higher resolution and quality than standard definition. build your future with our quality education. the best and largest all-in-one online tutoring platform in the world</p>
