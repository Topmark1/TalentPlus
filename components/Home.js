  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row px-4  md:px-6 lg:px-14 2xl:px-40 pt-25 items-center ">
      <div className="text-white flex flex-col  text-center sm:text-start items-center sm:items-start sm:w-1/2 pt-3 sm:pt-0">
        ...
        <img    className='sm:hidden -mr-[210px]  -mt-[62px]' src='/images/home/sdirect.png' alt='arrow' />
       
      </div>
      <Image    
      className='hidden sm:flex transform scale-50 2xl:scale-100 mt-[170px] md:mt[280px] md:w-[170px] 2xl:w-[150px] sm:-mr-[20px] md:-ml-[90px] lg:-ml-[120px] 2xl:mr-[0px]  ' 
      src='/images/home/direct.png' 
      width={50}
      height={100}
      //layout='responsive'
      alt='direct' />
